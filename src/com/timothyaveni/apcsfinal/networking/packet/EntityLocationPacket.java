...
public class EntityLocationPacket extends Packet {
	...
	public EntityLocationPacket(int id, int entityId, Location location) {
		super(id);
	...
	public void pack(byte[] data) {
		...
		ByteArrayTools.setBytes(data, location.getWorldSectionId(), 8, 1);
	...
	public void unpack(byte[] data) {
		...
		this.location = new Location(ByteArrayTools.readBytes(data, 9, 4, true), ByteArrayTools.readBytes(data, 13, 4,
				true), ByteArrayTools.readBytes(data, 17, 1, false), ByteArrayTools.readBytes(data, 8, 1, false));
	}
