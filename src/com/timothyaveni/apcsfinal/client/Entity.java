...
public abstract class Entity {
	...
	public String name; // name of the entity in terms of type (so Tank's name
						// is Tank)
	public String fileLocation; // stream that represents the files location in
								// the res folder
	...
	public Entity(String name, String location, int height, int width, int strength, int intelligence, int speed) {
		this.name = name;
